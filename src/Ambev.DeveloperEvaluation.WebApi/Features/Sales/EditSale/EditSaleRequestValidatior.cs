...
{
    public class EditSaleRequestValidatior : AbstractValidator<EditSaleRequest>
    {

        public EditSaleRequestValidatior()
        {
            ...
            RuleForEach(x => x.Items).SetValidator(new EditSaleItemRequestValidatior());
        }
    }
}
