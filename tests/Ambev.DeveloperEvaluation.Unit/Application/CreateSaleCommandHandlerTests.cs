...
namespace Ambev.DeveloperEvaluation.Unit.Application
{
    public class CreateSaleCommandHandlerTests
    {
        ...
        {
            // Arrange
            var command = CreateSaleCommandTestData.GenerateCommandWithEmptySaleNumber();
        ...
        {
            // Arrange
            var command = CreateSaleCommandTestData.GenerateCommandWithInvalidProductIdInItem();
