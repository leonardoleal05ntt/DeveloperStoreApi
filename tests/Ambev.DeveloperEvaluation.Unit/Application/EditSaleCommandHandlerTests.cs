...
{
    public class EditSaleCommandHandlerTests
    {
        ...
        public EditSaleCommandHandlerTests()
        {
        ...
        {
            // Arrange
            var command = EditSaleCommandTestData.GenerateValidCommand();
        ...
        {
            // Arrange
            var command = EditSaleCommandTestData.GenerateCommandWithEmptySaleNumber();
        ...
        {
            // Arrange
            var command = EditSaleCommandTestData.GenerateCommandWithInvalidProductIdInItem();
